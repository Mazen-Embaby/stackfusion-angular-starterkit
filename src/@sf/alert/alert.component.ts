...
export class AlertComponent {
  ...
  colorClasses: Record<AlertColor, string> = {
    ...
    red: 'text-red-800 bg-red-50 border-red-500 dark:bg-gray-800 dark:text-red-400',
    green: 'text-green-700 bg-green-100 border-green-500 dark:bg-green-200 dark:text-green-800',
    yellow: 'text-yellow-800 bg-yellow-50 border-yellow-500 dark:bg-gray-800 dark:text-yellow-300',
  ...
  buttonColorClasses: Record<AlertColor, string> = {
    ...
    yellow:
      'bg-yellow-50 text-yellow-800 hover:bg-yellow-200 focus:ring-yellow-400 dark:bg-gray-800 dark:text-yellow-300 dark:hover:bg-gray-300',
