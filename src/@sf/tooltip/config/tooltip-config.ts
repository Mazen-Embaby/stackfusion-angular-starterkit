...
export const FlowbiteTooltipConfigToken = new InjectionToken<FlowbiteTooltipConfig>('FlowbiteTooltipConfigToken');
 ...
 */
export const provideFlowbiteTooltipConfig = (config: Partial<FlowbiteTooltipConfig>): Provider[] => [
  {
