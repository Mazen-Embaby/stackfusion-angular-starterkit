...
export const FlowbiteDropdownConfigToken = new InjectionToken<FlowbiteDropdownConfig>('FlowbiteDropdownConfigToken');
 ...
 */
export const provideFlowbiteDropdownConfig = (config: Partial<FlowbiteDropdownConfig>): Provider[] => [
  {
