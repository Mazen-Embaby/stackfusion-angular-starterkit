import { Injectable, RendererStyleFlags2, SimpleChanges, inject } from '@angular/core';
...
export class MarqueeService {
  private _reducedMotionService = inject(ReducedMotionService);
  private _marqueeDuplicationService = inject(MarqueeDuplicationService);
